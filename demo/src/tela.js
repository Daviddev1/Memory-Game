...
class Tela{
    ...
    static iniciarContador() {
        ...
        atualizarTexto()
        // a cada segundo, vai chamar a funcao atualizarTexto essa funçao vai substituir o $$contador pelo `contarAte` diminuindo o valor. Depois retornamos o idDoIntervalo para ele mais tarde
        const idDoIntervalo = setInterval(atualizarTexto, 1000)
        return idDoIntervalo
    }
    static limparContador(idDoIntervalo) {
        clearInterval(idDoIntervalo) // para parar o intervalo de ficar rodando

        //Deixamos sem texto para nao mostar mais nada
